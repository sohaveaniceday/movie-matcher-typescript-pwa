...
import { HoldingPage, Button } from './common'
...
export const AboutPage: FC<LandingPageProps> = ({
  ...
  return (
    ...
    >
      <div
        className='p-5 m-auto overflow-auto text-white align-middle'
      ...
      >
        ...
        <div className='mb-6 text-lg'>
          Users take it in turns to pick a shortlist of 3 movies each, then rate
          their preferences based on those movies.
          <br />
          <br />A special algorithm then works out the ideal match. It will also
          help you to see where the film is available to watch.
          <br />
          <br />
